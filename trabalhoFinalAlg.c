...
ver a porra do relatorio se foder
categoria gasto(lazer, saude, higiene, aposta, outro)
categoria provento(trabalho, doacao, heranca, aposta, outro)
